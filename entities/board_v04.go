...
func (board *BoardV04) PrimitiveMonteCalro(color int, printBoardType1 func(int, int, int, int)) int {
...
func (board *BoardV04) GetComputerMove(color int, fUCT int, printBoard func(int, int, int, int)) int {
