...
// Playout - 最後まで石を打ちます。
func (board *BoardV02) Playout(turnColor int, printBoard func(int, int, int, int)) int {
...
func (board *BoardV02) PrimitiveMonteCalro(color int, printBoard func(int, int, int, int)) int {
...
func (board *BoardV02) GetComputerMove(color int, fUCT int, printBoard func(int, int, int, int)) int {
